package com.sistema.credito.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.sistema.credito.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.sistema.credito.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
